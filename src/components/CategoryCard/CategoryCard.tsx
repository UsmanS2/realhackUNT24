...
const CategoryCard = ({ title, score, nobg = false, onClick }: CategoryCardProps): JSX.Element => {
  ...
  return (
    <div
      onClick={onClick}
      className={`${nobg ? '' : 'bg-white'} ${nobg ? '' : 'shadow-lg'} p-6 rounded-lg text-center`}
    >
      <p className="font-semibold">{title}</p>
      <div className="flex flex-col items-center">
        <p className="text-lg font-bold">Health Score</p>
